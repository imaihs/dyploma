...
extern touchgfx::GeneratedFont& getFont_inter_SemiBold_28_4bpp();
extern touchgfx::GeneratedFont& getFont_inter_SemiBold_48_4bpp();
extern touchgfx::GeneratedFont& getFont_inter_SemiBold_150_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_inter_SemiBold_28_4bpp()),
    &(getFont_inter_SemiBold_48_4bpp()),
    &(getFont_inter_SemiBold_150_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_inter_SemiBold_28_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_inter_SemiBold_48_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_inter_SemiBold_150_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
